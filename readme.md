...
This is text-based game with a 2d map that I completed as a project for coursework at Oregon State University. The inspiration for the gameplay is from the original ToeJam & Earl game for Sega Genesis, though this is obviously much more simplified.
